...
#### Vacuum Mail Index
Quit Mail, vacuum the SQLite index, then re-open Mail. On a large email database that hasn't been optimized for a while, this can provide significant improvements in responsiveness and speed.
```bash
osascript -e 'tell application "Mail" to quit'
ls -lh ~/Library/Mail/V[234]/MailData/Envelope\ Index # before
/usr/bin/sqlite3 ~/Library/Mail/V[234]/MailData/Envelope\ Index vacuum
ls -lh ~/Library/Mail/V[234]/MailData/Envelope\ Index # after
open -a Mail
```
