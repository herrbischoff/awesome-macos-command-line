...
- [Monoid](https://github.com/larsenwork/monoid) - A crisp fixed width font, to fit manay characters in each line while keeping it easily readable, with great ligatures for writing code. 
